        ...
        <div className="min-h-screen px-6 py-10 bg-gray-50 dark:bg-zinc-900">
            ...
            <div className="bg-white dark:bg-zinc-800 shadow-md rounded-lg p-8 max-w-2xl mx-auto">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button className="bg-[#1074b9] hover:bg-[#1074c9] text-white cursor-pointer">
                                    <FontAwesomeIcon icon={faGear} />Change Password
                                </Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent>
                                <AlertDialogHeader>
                ...
                <div className="grid grid-cols-2 gap-y-5 text-sm text-zinc-700 dark:text-zinc-200">
                    ...
                    <div className="text-zinc-600 dark:text-zinc-400">{users?.username}</div>

                    <div className="font-medium">First Name</div>
                    <div className="text-zinc-600 dark:text-zinc-400">{users?.firstname}</div>

                    <div className="font-medium">Last Name</div>
                    <div className="text-zinc-600 dark:text-zinc-400">{users?.lastname}</div>

                    <div className="font-medium">Email</div>
                    <div className="text-zinc-600 dark:text-zinc-400">{users?.email}</div>

                    <div className="font-medium">Office</div>
                    <div className="text-zinc-600 dark:text-zinc-400">{users?.officeName}</div>
