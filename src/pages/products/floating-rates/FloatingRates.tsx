  ...
  return (
    <div className="min-h-screen px-6 py-10 max-w-7xl mx-auto text-[15px]">
      ...
      <div className="flex flex-wrap justify-between items-center gap-6 mb-6">
        ...
        {/* Items per page + Prev/Next controls */}
      ...
      {/* Table for listing floating rates */}
        ...
        <Table>
          ...
          <TableHeader>
            <TableRow className="text-base">
              ...
              <TableHead className="px-6 py-4">Is Base Lending Rate?</TableHead>
          ...
          <TableBody>
            {paginated.map((r) => (
              <TableRow
                ...
                onClick={() => navigate(`/products/floating-rates/${r.id}`)} // 🔹 FIX: use actual id here
              >
                {/* Name */}
                ...
                {/* Active indicator */}
                <TableCell className="px-6 py-4 text-green-600">
                  {r.isActive ? <CheckCircle2 className="w-5 h-5" /> : null}
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
