...
import { FixedDepositProductApi, type GetFixedDepositProductsProductIdResponse } from "@/fineract-api";
...
const ViewFixedDepositProducts = () => {
    ...
    const [fdProducts, setFdProducts] = useState<GetFixedDepositProductsProductIdResponse>();
        ...
        <div className="min-h-screen px-6 py-10 bg-gray-50 dark:bg-zinc-900">
            ...
            <AppBreadCrumbs
                items={[
                    ...
                    { label: " Fixed Deposit Products", href: "/products/fixed-deposit-products" },
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-md border border-zinc-200 dark:border-zinc-700 shadow-sm">
                ...
                <div className="p-6 grid grid-cols-2 gap-y-4 text-sm">
                    ...
                    <div>{fdProducts?.interestCalculationDaysInYearType?.code ?? "—"}</div>
                </div>
                <Separator className="my-6 h-[1px] w-full bg-zinc-200 dark:bg-zinc-700" />
                ...
                <div className="p-6 grid grid-cols-2 gap-y-4 text-sm">
                    ...
                    <div className="font-medium text-zinc-500 dark:text-zinc-400">Apply Penal Interest (less):</div>
                ...
                <h2 className="text-md font-semibold text-blue-600 mt-5 mb-2 ml-4">Interest Rate Chart</h2>
                <div className="p-6 grid grid-cols-2 gap-y-4 text-sm">
                    ...
                    <div className="font-medium text-zinc-500 dark:text-zinc-400">From Date:</div>
