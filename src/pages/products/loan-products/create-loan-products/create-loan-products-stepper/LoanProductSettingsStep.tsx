    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-6">
                <div className="flex">
                    <Checkbox className="mr-4" />
                    <Label className="text-sm">Calculate interest for exact days in partial period</Label>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="flex">
                        <Checkbox className="mr-4" />
                        <Label className="text-sm">Allow fixing of the installment amount</Label>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="md:flex-row gap-6">
                        <div className="mt-2 flex-1 space-y-2">
                            <Label className="font-semibold">Number of days a loan may be overdue before moving into arrears</Label>
                            <Input type="number" />
                        </div>

                        <div className="mt-2 flex-1 space-y-2">
                            <Label className="font-semibold">Maximum number of days a loan may be overdue before becoming a NPA (non performing asset)</Label>
                            <Input type="number" />
                        </div>

                        <div className="mt-2 space-y-2">
                            <Checkbox className="mr-4" />
                            <Label className="text-sm">Account moves out of NPA only after all arrears have been cleared</Label>
                            <Input type="number" />
                        </div>
                        ...
                        <div className="mt-5 flex gap-5">
                            <div className="flex">
                                <Checkbox className="mr-4" />
                                <Label className="text-sm">Are Variable Installments allowed?</Label>
                            </div>

                            <div className="flex">
                                <Checkbox className="mr-4" />
                                <Label className="text-sm">Allowed to be used for providing Top Up Loans</Label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <Label className="text-md font-semibold">Interest Recalculation</Label>
                ...
                <div className="flex flex-col gap-4">
                    <Label className="text-md font-semibold">Guarantee Requirements</Label>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex">
                            <Checkbox className="mr-4" />
                            <Label className="text-sm">Use the Global Configurations values to the Repayment Event (notifications)</Label>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-4">
                    <Label className="text-md font-semibold">Configurable Terms and Settings</Label>

                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex">
                            <Checkbox className="mr-4" />
                            <Label className="text-sm">Allow overriding select terms and settings in loan accounts</Label>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex">
                            <Checkbox className="mr-4" />
                            <Label className="text-sm">Number of days a loan may be overdue before moving into arrears</Label>
                        </div>
                    </div>
                </div>
