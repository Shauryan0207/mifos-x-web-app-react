...
const DelinquencyRange = () => {
  ...
  return (
    <div className="min-h-screen px-6 py-10 max-w-7xl mx-auto text-[15px]">
      ...
      {/* Add new delinquency range button */}
      <div className="mb-6">
        <Button
      ...
      <div className="flex flex-wrap justify-between items-center gap-6 mb-6">
        ...
        {/* Items per page + prev/next buttons */}
        ...
        <Table>
          ...
          <TableHeader>
            <TableRow className="text-base">
              ...
              <TableHead className="px-6 py-4">Days From</TableHead>
              <TableHead className="px-6 py-4">Days Till</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {paginated.map((r) => (
