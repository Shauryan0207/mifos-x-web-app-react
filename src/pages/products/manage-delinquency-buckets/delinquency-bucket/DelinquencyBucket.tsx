    ...
    <div className="min-h-screen px-6 py-10 max-w-7xl mx-auto text-[15px]">
      ...
      <div className="mb-6">
        <Button
          ...
          onClick={() =>
            navigate("/products/delinquency-bucket-configurations/buckets/create")
          }
        >
          ...
          <TableBody>
            {paginated.map((b) => (
              <TableRow
                ...
                onClick={() => navigate(`/products/delinquency-bucket-configurations/buckets/${b.id}`)} // navigate to bucket details
              >
