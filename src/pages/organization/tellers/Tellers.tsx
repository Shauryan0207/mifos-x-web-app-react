...
import { TellerCashManagementApi, type GetTellersResponse } from "@/fineract-api";
                ...
                <Table>
                    ...
                    <TableHeader>
                        <TableRow className="text-base">
                            ...
                            <TableHead className="px-6 py-4 text-center">Started On</TableHead>
                        ...
                        {paginated.map((teller) => (
                            ...
                            >
                                ...
                                <TableCell className="px-6 py-4 text-center">
                                    ...
                                    <Button
                                        variant="link"
                                        onClick={() => navigate(`/organization/tellers/${teller.id}/cashiers`)}
