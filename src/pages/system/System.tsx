...
const systemItems = [
  ...
  { icon: faKey, name: "Manage Roles and Permissions", path: "/system/roles-and-permissions" },
  { icon: faClock, name: "Manage Jobs", path: "/system/jobs" },
  { icon: faProjectDiagram, name: "Configure Maker Checker Tasks", path: "/system/maker-checker" },
  { icon: faCogs, name: "Configurations", path: "/system/configurations" },
  { icon: faAnchor, name: "Manage Hooks", path: "/system/hooks" },
  { icon: faKey, name: "Account Number Preferences", path: "/system/account-number-preferences" },
  { icon: faRoad, name: "Entity to Entity Mapping", path: "/system/entity-mapping" },
  { icon: faTools, name: "External Services", path: "/system/external-services" },
  { icon: faFileAlt, name: "Manage Surveys", path: "/system/surveys", disabled: true },
  { icon: faKey, name: "Two-Factor Authentication", path: "/system/two-factor-auth", disabled: true },
  { icon: faAnchor, name: "Manage External Events", path: "/system/external-events" },
];
