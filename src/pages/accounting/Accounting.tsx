...
export const accountingItems = [
  { icon: faRepeat, name: "Frequent Postings", path: "/accounting/journal-entries/frequent-postings" },
  { icon: faProjectDiagram, name: "Chart of Accounts", path: "/accounting/chart-of-accounts" },
  { icon: faPlus, name: "Create Journal Entries", path: "/accounting/journal-entries/create" },
  { icon: faCog, name: "Closing Entries", path: "/accounting/closing-entries" },
  { icon: faSearch, name: "Search Journal Entries", path: "/accounting/journal-entries" },
  { icon: faList, name: "Accounting Rules", path: "/accounting/accounting-rules" },
  { icon: faLink, name: "Accounts Linked to Financial Activities", path: "/accounting/financial-activity-mappings" },
  { icon: faCalendar, name: "Accruals", path: "/accounting/accruals" },
  { icon: faMoneyBill, name: "Migrate Opening Balances (Office-wise)", path: "/accounting/opening-balances" },
  { icon: faChartBar, name: "Provisioning Entries", path: "/accounting/provisioning-entries" },
];
